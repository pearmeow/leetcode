 ...
 * where: status[i] is 1 if the ith box is open and 0 if the ith box is closed, candies[i] is the number of candies
 * in the ith box, keys[i] is a list of the labels of the boxes you can open after opening the ith box.
