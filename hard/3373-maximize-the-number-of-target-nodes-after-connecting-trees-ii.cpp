...
public:
    ...
    int targetDFS(const std::vector<std::vector<int>>& adjList, std::vector<bool>& visited, bool parity,
                  int root) {
        int res = 0;
    ...
    void updateDFS(const std::vector<std::vector<int>>& adjList, std::vector<bool>& updated,
                   std::vector<int>& maxTargets, bool parity, int root, int targetVal) {
