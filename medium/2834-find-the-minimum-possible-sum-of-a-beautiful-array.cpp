 ...
 * There doesn't exist two distinct indices, i and j, in the range [0, n - 1], such that nums[i] + nums[j] ==
 * target. Return the minimum possible sum that a beautiful array could have modulo 10^9 + 7.
 */
