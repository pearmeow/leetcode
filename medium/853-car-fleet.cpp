 ...
 * the ith car and speed[i] is the speed of the ith car in miles per hour. A car cannot pass another car, but it
 * can catch up and then travel next to it at the speed of the slower car. A car fleet is a car or cars driving
 * next to each other. The speed of the car fleet is the minimum speed of any car in the fleet. If a car catches up
 * to a car fleet at the mile target, it will still be considered as part of the car fleet. Return the number of
